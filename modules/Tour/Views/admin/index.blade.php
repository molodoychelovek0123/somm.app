    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            ...
            <div class="title-actions">
                @if(empty($recovery))
                <a target="_self" href="{{route('tour.admin.create')}}" class="btn btn-primary">{{__("Add new class")}}</a>
                @endif
            </div>
        </div>
                            ...
                            @if($rows->total() > 0)
                                @foreach($rows as $row)
                                    <tr class="{{$row->status}}">
                                        ...
                                        <td class="title">
                                            <a target="_self" href="{{url('admin/module/experience/edit/'.$row->id)}}">{{$row->title}}</a>
                                        </td>
                                        ...
                                        <td>
                                            <a target="_self" href="{{route('tour.admin.edit',['id'=>$row->id])}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> {{__('Edit')}}
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
