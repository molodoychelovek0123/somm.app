<div class="panel">
    <div class="panel-title"><strong>Host block</strong></div>
...
@if(!empty($translation->host_description)) {{$translation->host_description}} @else Description @endif
                ...
                <em>don't leave the description empty (causes errors)</em>
...
@foreach ($attributes as $attribute)
    <div class="panel">
        <div class="panel-title"><strong>{{__('Attribute: :name',['name'=>$attribute->name])}}</strong>
        <em>If the block at the top is filled in, these attributes will be assigned to it</em></div>
        <div class="panel-body">
