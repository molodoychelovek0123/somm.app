...
@if(is_default_lang())
    <div class="form-group">
        <label>{{__('Icon')}} - {!!  __("get icon in <a target="_self" href=':link_1' target='_blank'>fontawesome.com</a> or <a target="_self" href=':link_2' target='_blank'>icofont.com</a>",['link_1'=>'https://fontawesome.com/v4.7.0/icons/','link_2'=>'https://icofont.com/icons'])  !!}</label>
