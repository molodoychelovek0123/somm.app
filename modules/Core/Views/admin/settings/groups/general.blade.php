        ...
        <div class="col-sm-8">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>{{__("Or select Hotel for Homepage")}}</label>
                        <div class="form-controls">
                            <?php
                            $template = !empty($settings['home_hotel_id']) ? \Modules\Hotel\Models\Hotel::find($settings['home_hotel_id']) : false;

                            \App\Helpers\AdminForm::select2('home_hotel_id', [
                                'configs' => [
                                    'ajax' => [
                                        'url'      => url('/admin/module/hotel/getForSelect2'),
                                        'dataType' => 'json'
                                    ]
                                ]
                            ],
