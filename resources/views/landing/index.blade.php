...
<head>
    <meta charset="UTF-8"/>
    <title>Somm app - Ultimate Booking System</title>
                ...
                <div class="col-xs-9">
                    <div class="dropdown dropdown-main-menu">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a target="_blank" class="dropdown-item" href="http://docs.somm.app">Documentation</a>
                    ...
                    <ul class="menu">
                        ...
                        <li><a target="_blank" href="http://docs.somm.app">Documentation</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Somm app</span> is super<br />fast and easy <img src="{{url('landing/img/hand.svg')}}" /></h3>
